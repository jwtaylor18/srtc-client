      ...
      <div className="mt-3 row">
        <div className="col-12 col-xl-6">
          <div className="mb-3 row">
            <div className="font-weight-bold col-sm-4">Name:</div>
            <div className="col-sm-8">{facility.facilityName}</div>
          </div>
          <div className="mb-3 row">
            <div className="font-weight-bold col-sm-4">Court Surface:</div>
            <div className="col-sm-8">{facility.courtSurface}</div>
          </div>
          <div className="mb-3 row">
            <div className="font-weight-bold col-sm-4">Number of Courts:</div>
            <div className="col-sm-8">{facility.numCourts}</div>
          </div>
          <div className="mb-3 row">
            <div className="font-weight-bold col-sm-4">Phone:</div>
            <div className="col-sm-8">{facility.phone}</div>
          </div>
          <div className="mb-3 row">
            <div className="font-weight-bold col-sm-4">Email Address:</div>
        ...
        <div className="col-12 col-xl-6">
          <div className="mb-3 row">
            <div className="font-weight-bold col-sm-4">Street Address:</div>
            <div className="col-sm-8">{facility.streetAddress}</div>
          </div>
          <div className="mb-3 row">
            <div className="font-weight-bold col-sm-4">City:</div>
            <div className="col-sm-8">{facility.city}</div>
          </div>
          <div className="mb-3 row">
            <div className="font-weight-bold col-sm-4">State:</div>
          ...
          <div className="mb-3 row">
            <div className="font-weight-bold col-sm-4">Country:</div>
